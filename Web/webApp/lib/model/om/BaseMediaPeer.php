...
abstract class BaseMediaPeer {
	...
	const ARCHIVO = 'media.ARCHIVO';

	/** the column name for the TIPO field */
	const TIPO = 'media.TIPO';

	/** the column name for the PERSONA_ID field */
	const PERSONA_ID = 'media.PERSONA_ID';

	/** the column name for the PERSONAS_SCOUTING_ID field */
	const PERSONAS_SCOUTING_ID = 'media.PERSONAS_SCOUTING_ID';

	/** the column name for the PERSONAS_CASTING_ID field */
	const PERSONAS_CASTING_ID = 'media.PERSONAS_CASTING_ID';

	/** the column name for the ORDEN field */
	const ORDEN = 'media.ORDEN';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Archivo', 'Tipo', 'PersonaId', 'PersonasScoutingId', 'PersonasCastingId', 'Orden', 'CreatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'archivo', 'tipo', 'personaId', 'personasScoutingId', 'personasCastingId', 'orden', 'createdAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::ARCHIVO, self::TIPO, self::PERSONA_ID, self::PERSONAS_SCOUTING_ID, self::PERSONAS_CASTING_ID, self::ORDEN, self::CREATED_AT, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'ARCHIVO', 'TIPO', 'PERSONA_ID', 'PERSONAS_SCOUTING_ID', 'PERSONAS_CASTING_ID', 'ORDEN', 'CREATED_AT', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'archivo', 'tipo', 'persona_id', 'personas_scouting_id', 'personas_casting_id', 'orden', 'created_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Archivo' => 1, 'Tipo' => 2, 'PersonaId' => 3, 'PersonasScoutingId' => 4, 'PersonasCastingId' => 5, 'Orden' => 6, 'CreatedAt' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'archivo' => 1, 'tipo' => 2, 'personaId' => 3, 'personasScoutingId' => 4, 'personasCastingId' => 5, 'orden' => 6, 'createdAt' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::ARCHIVO => 1, self::TIPO => 2, self::PERSONA_ID => 3, self::PERSONAS_SCOUTING_ID => 4, self::PERSONAS_CASTING_ID => 5, self::ORDEN => 6, self::CREATED_AT => 7, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'ARCHIVO' => 1, 'TIPO' => 2, 'PERSONA_ID' => 3, 'PERSONAS_SCOUTING_ID' => 4, 'PERSONAS_CASTING_ID' => 5, 'ORDEN' => 6, 'CREATED_AT' => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'archivo' => 1, 'tipo' => 2, 'persona_id' => 3, 'personas_scouting_id' => 4, 'personas_casting_id' => 5, 'orden' => 6, 'created_at' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(MediaPeer::ARCHIVO);
			$criteria->addSelectColumn(MediaPeer::TIPO);
			$criteria->addSelectColumn(MediaPeer::PERSONA_ID);
			$criteria->addSelectColumn(MediaPeer::PERSONAS_SCOUTING_ID);
			$criteria->addSelectColumn(MediaPeer::PERSONAS_CASTING_ID);
			$criteria->addSelectColumn(MediaPeer::ORDEN);
			...
			$criteria->addSelectColumn($alias . '.PERSONAS_SCOUTING_ID');
			$criteria->addSelectColumn($alias . '.PERSONAS_CASTING_ID');
	...
	public static function doCountJoinPersona(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(MediaPeer::PERSONA_ID, PersonaPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Media objects pre-filled with their Persona objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinPersona(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		MediaPeer::addSelectColumns($criteria);
		$startcol = (MediaPeer::NUM_COLUMNS - MediaPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Media) to $obj2 (Persona)
				$obj2->addMedia($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		MediaPeer::addSelectColumns($criteria);
		$startcol2 = (MediaPeer::NUM_COLUMNS - MediaPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Media) to the collection in $obj2 (Persona)
				$obj2->addMedia($obj1);
