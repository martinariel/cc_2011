...
class DbFinder extends sfModelFinder
{
  ...
  {
    if($this->type == self::PROPEL)
    {
      return $this->adapter->getCriteria();
    }
    else if($this->type == self::DOCTRINE)
    {
  ...
  public function __call($name, $arguments)
  {
    ...
    throw new Exception(sprintf('Undefined method DbFinder::%s()', $name));
  }
