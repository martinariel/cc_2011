...
class sfPropelFinder extends sfModelFinder
{
  ...
  public function setClass($class, $alias = '')
  {
    ...
    $this->addRelation($this->peerClass, $alias);
    $this->initialize();
  ...
  public function doFind()
  {
    ...
    else
    {
      ...
      return call_user_func(array($this->peerClass, 'doSelect'), $this->buildCriteria(), $this->getConnection());
    }
  }
  ...
  public function join()
  {
    ...
    switch(count($args))
    {
      ...
      case 2:
        ...
        $this->addRelation(sfPropelFinderUtils::getPeerClassFromClass($relatedClass), $alias);
