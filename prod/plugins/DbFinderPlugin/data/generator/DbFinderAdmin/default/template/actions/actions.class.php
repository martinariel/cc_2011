...
<?php endforeach; ?>
  ...
  protected function get<?php echo $this->getClassName() ?>OrCreate(<?php echo $this->getMethodParamsForGetOrCreate() ?>)
  {
    ...
    {
      $<?php echo $this->getSingularName() ?> = DbFinder::from('<?php echo $this->getClassName() ?>')->findPk(<?php echo $this->getRetrieveByPkParamsForGetOrCreate() ?>);
...
<?php else: ?>
    ...
    {
<?php if ($type == 'string'): ?>
      $finder->where('<?php echo $name ?>', 'like', strtr($this->filters['<?php echo $column->getName() ?>'], '*', '%'));
<?php else: ?>
...
<?php endif; ?>
  ...
  protected function addSort($finder)
  {
    if ($sort_column = $this->getUser()->getAttribute('sort', null, 'sf_admin/<?php echo $this->getSingularName() ?>/sort'))
    {
      ...
      $finder->orderBy($sort_column, $this->getUser()->getAttribute('type', null, 'sf_admin/<?php echo $this->getSingularName() ?>/sort'));
    }
  }
