...
abstract class BaseMedia extends BaseObject  implements Persistent
{
	...
	/**
	 * The value for the personas_scouting_id field.
	 * Note: this column has a database default value of: -1
	 * @var        int
	 */
	protected $personas_scouting_id;

	/**
	 * The value for the personas_casting_id field.
	 * Note: this column has a database default value of: -1
	 * @var        int
	 */
	protected $personas_casting_id;
	...
	public function applyDefaultValues()
	{
		$this->archivo = '';
		$this->tipo = '';
		$this->personas_scouting_id = -1;
		$this->personas_casting_id = -1;
		$this->orden = 0;
	}
	...
	/**
	 * Get the [personas_scouting_id] column value.
	 * 
	 * @return     int
	 */
	public function getPersonasScoutingId()
	{
		return $this->personas_scouting_id;
	}

	/**
	 * Get the [personas_casting_id] column value.
	 * 
	 * @return     int
	 */
	public function getPersonasCastingId()
	{
		return $this->personas_casting_id;
	}
	...
	public function setArchivo($v)
	{
		...
		if ($this->archivo !== $v || $this->isNew()) {
			$this->archivo = $v;
			$this->modifiedColumns[] = MediaPeer::ARCHIVO;
		}
	...
	public function setPersonaId($v)
	{
		...
		if ($this->persona_id !== $v) {
			$this->persona_id = $v;
			$this->modifiedColumns[] = MediaPeer::PERSONA_ID;
		}
	...
	/**
	 * Set the value of [personas_scouting_id] column.
	 * 
	 * @param      int $v new value
	 * @return     Media The current object (for fluent API support)
	 */
	public function setPersonasScoutingId($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->personas_scouting_id !== $v || $this->isNew()) {
			$this->personas_scouting_id = $v;
			$this->modifiedColumns[] = MediaPeer::PERSONAS_SCOUTING_ID;
		}

		return $this;
	} // setPersonasScoutingId()

	/**
	 * Set the value of [personas_casting_id] column.
	 * 
	 * @param      int $v new value
	 * @return     Media The current object (for fluent API support)
	 */
	public function setPersonasCastingId($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->personas_casting_id !== $v || $this->isNew()) {
			$this->personas_casting_id = $v;
			$this->modifiedColumns[] = MediaPeer::PERSONAS_CASTING_ID;
		}

		return $this;
	} // setPersonasCastingId()
	...
	public function setOrden($v)
	{
		...
		if ($this->orden !== $v || $this->isNew()) {
			$this->orden = $v;
			$this->modifiedColumns[] = MediaPeer::ORDEN;
		}
	...
	public function hasOnlyDefaultValues()
	{
			...
			if ($this->personas_scouting_id !== -1) {
				return false;
			}

			if ($this->personas_casting_id !== -1) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->personas_scouting_id = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
			$this->personas_casting_id = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
			...
			return $startcol + 8; // 8 = MediaPeer::NUM_COLUMNS - MediaPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 3:
				...
				break;
			case 4:
				return $this->getPersonasScoutingId();
				break;
			case 5:
				return $this->getPersonasCastingId();
				break;
			case 6:
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $includeForeignObjects = false)
	{
		...
		$result = array(
			...
			$keys[4] => $this->getPersonasScoutingId(),
			$keys[5] => $this->getPersonasCastingId(),
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 3:
				...
				break;
			case 4:
				$this->setPersonasScoutingId($value);
				break;
			case 5:
				$this->setPersonasCastingId($value);
				break;
			case 6:
				$this->setOrden($value);
				break;
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[4], $arr)) $this->setPersonasScoutingId($arr[$keys[4]]);
		if (array_key_exists($keys[5], $arr)) $this->setPersonasCastingId($arr[$keys[5]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(MediaPeer::ARCHIVO)) $criteria->add(MediaPeer::ARCHIVO, $this->archivo);
		if ($this->isColumnModified(MediaPeer::TIPO)) $criteria->add(MediaPeer::TIPO, $this->tipo);
		if ($this->isColumnModified(MediaPeer::PERSONA_ID)) $criteria->add(MediaPeer::PERSONA_ID, $this->persona_id);
		if ($this->isColumnModified(MediaPeer::PERSONAS_SCOUTING_ID)) $criteria->add(MediaPeer::PERSONAS_SCOUTING_ID, $this->personas_scouting_id);
		if ($this->isColumnModified(MediaPeer::PERSONAS_CASTING_ID)) $criteria->add(MediaPeer::PERSONAS_CASTING_ID, $this->personas_casting_id);
		if ($this->isColumnModified(MediaPeer::ORDEN)) $criteria->add(MediaPeer::ORDEN, $this->orden);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setPersonasScoutingId($this->personas_scouting_id);
		$copyObj->setPersonasCastingId($this->personas_casting_id);
	...
	public function clear()
	{
		...
		$this->personas_scouting_id = null;
		$this->personas_casting_id = null;
		$this->orden = null;
	...
	{
		// symfony_behaviors behavior
		if ($callable = sfMixer::getCallable('BaseMedia:' . $name))
		{
