...
abstract class BaseNacionalidad extends BaseObject  implements Persistent
{
	...
	/**
	 * Initializes internal state of BaseNacionalidad object.
	 * @see        applyDefaults()
	 */
	...
	public function setDescripcion($v)
	{
		...
		if ($this->descripcion !== $v || $this->isNew()) {
			$this->descripcion = $v;
			$this->modifiedColumns[] = NacionalidadPeer::DESCRIPCION;
		}
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(NacionalidadPeer::ID) ) {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(NacionalidadPeer::DESCRIPCION)) $criteria->add(NacionalidadPeer::DESCRIPCION, $this->descripcion);
	 ...
	 * If this Nacionalidad is new, it will return
	...
	{
		// symfony_behaviors behavior
		if ($callable = sfMixer::getCallable('BaseNacionalidad:' . $name))
		{
