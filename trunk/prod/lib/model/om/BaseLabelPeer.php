...
abstract class BaseLabelPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Label';
	...
	const DESCRIPCION = 'label.DESCRIPCION';
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(LabelPeer::DESCRIPCION);
		} else {
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		{
		  call_user_func($sf_hook, 'BaseLabelPeer', $criteria, $con);
		}
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = LabelPeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + LabelPeer::NUM_COLUMNS;
		} else {
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseLabelPeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
