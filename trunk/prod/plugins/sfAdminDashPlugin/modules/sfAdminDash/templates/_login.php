...
<div id="ctr" align="center">
  <div class="login">
        ...
        <div class="form-block">
          ...
          <?php if(isset($form['_csrf_token'])): ?>
            <?php echo $form['_csrf_token']->render(); ?> 
			    <?php endif; ?>
          <div class="inputlabel"><?php echo $form['username']->renderLabel(__('Usuario', array(), 'sf_admin_dash')); ?>:</div>
          <div>
            <?php echo $form['username']->renderError(); ?>
            <?php echo $form['username']->render(array('class' => 'inputbox')); ?>
          </div>
          <div class="inputlabel"><?php echo $form['password']->renderLabel(__('Contraseña', array(), 'sf_admin_dash')); ?>:</div>
          <div>
            <?php echo $form['password']->renderError(); ?>
            <?php echo $form['password']->render(array('class' => 'inputbox')); ?>
          </div>
          <div class="inputlabel">
            <?php echo $form['remember']->renderLabel(__('Recordarme', array(), 'sf_admin_dash')); ?>
    ...
    <div class="login-text">
      ...
      <p><?php echo __('Bienvenido a ', array(), 'sf_admin_dash'); ?> <?php echo sfAdminDash::getProperty('site'); ?></p>
      <p><?php echo __('Identifíquese para ingresar a la aplicación.', array(), 'sf_admin_dash'); ?></p>
    </div>
