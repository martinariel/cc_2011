...
abstract class BaseGrupoPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Nivel', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'nivel', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NIVEL, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NIVEL', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'nivel', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Nivel' => 1, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'nivel' => 1, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NIVEL => 1, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NIVEL' => 1, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'nivel' => 1, ),
		BasePeer::TYPE_NUM => array (0, 1, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(GrupoPeer::NIVEL);
		} else {
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		{
		  call_user_func($sf_hook, 'BaseGrupoPeer', $criteria, $con);
		}
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = GrupoPeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + GrupoPeer::NUM_COLUMNS;
		} else {
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$value = $criteria->remove(GrupoPeer::ID);
			if ($value) {
				$selectCriteria->add(GrupoPeer::ID, $value, $comparison);
			} else {
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseGrupoPeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
